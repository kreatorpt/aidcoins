...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Aidcoins " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"aidcoinstools.com", "dnsseed.aidcoinstools.com"},
    {"aidcoinspool.org", "dnsseed.aidcoinspool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"aidcoinstools.com", "testnet-seed.aidcoinstools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Aidcoins is probably already running."), addrBind.ToString().c_str());
        else
